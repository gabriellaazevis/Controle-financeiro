...
if (isset($_POST['btnPesquisar'])) {
    ...
    $movs = $objDAO->ValidarConsultaPeriodo($tipoMov, $dtInicio, $dtFinal);
            ...
            <div id="page-inner"> 
                ...
                <form action="consultar_movimento.php" method="POST">
                    ...
                    <div style="text-align: center;">
                        <button class="btn btn-primary" name="btnPesquisar" onclick="return ValidarConsultaPeriodo();">Pesquisar</button>
                    </div>
                </form>
